    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-surface border-r border-gray-200 flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-1">
                <a href="{{ profession_route('dashboard') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs(profession_prefix() . '.dashboard') ? 'bg-primary-50 text-primary-600' : 'text-text-primary hover:bg-gray-50' }} transition-colors">
                ...
                <a href="{{ profession_route('patients.index') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs(profession_prefix() . '.patients.*') ? 'bg-primary-50 text-primary-600' : 'text-text-primary hover:bg-gray-50' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ profession_route('appointments.index') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs(profession_prefix() . '.appointments.*') ? 'bg-primary-50 text-primary-600' : 'text-text-primary hover:bg-gray-50' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ profession_route('clinical-notes.index') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs(profession_prefix() . '.clinical-notes.*') ? 'bg-primary-50 text-primary-600' : 'text-text-primary hover:bg-gray-50' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
