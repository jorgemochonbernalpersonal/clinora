                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center gap-2 ml-4">
                                ...
                                @if($consent->isSigned() && !$consent->isRevoked())
                                    {{-- Download PDF Button --}}
                                    <button wire:click="downloadPdf({{ $consent->id }})" 
                                            class="inline-flex items-center px-3 py-2 text-sm font-medium text-green-600 hover:text-green-700 hover:bg-green-50 rounded-lg transition-colors">
                                    ...
                                    {{-- Send Email Button --}}
                                    <button wire:click="sendEmail({{ $consent->id }})" 
