            ...
            @empty
                <div class="flex flex-col items-center justify-center h-64 text-center">
                    ...
                    @if($selectedPatientId)
                         ...
                         <a href="{{ route('clinical-notes.create', ['patient' => $selectedPatientId]) }}" class="mt-4 text-primary-600 hover:text-primary-700 font-medium text-sm">Crear primera nota &rarr;</a>
                    @else
