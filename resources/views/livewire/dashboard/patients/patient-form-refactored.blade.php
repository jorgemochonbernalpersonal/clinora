        ...
        <x-forms.section section="basic" title="Datos Identificativos" icon="user" :open="true">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <x-forms.field name="first_name" label="Nombre" required>
                    <x-forms.input name="first_name" placeholder="Nombre del paciente" :error="$errors->has('first_name')" />
                </x-forms.field>

                <x-forms.field name="last_name" label="Apellidos" required>
                    <x-forms.input name="last_name" placeholder="Apellidos del paciente" :error="$errors->has('last_name')" />
                </x-forms.field>
        ...
        <x-forms.section section="contact" title="Información de Contacto" icon="contact" :open="true">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <x-forms.field name="email" label="Email">
                    <x-forms.input type="email" name="email" placeholder="paciente@ejemplo.com" :error="$errors->has('email')" />
                </x-forms.field>
