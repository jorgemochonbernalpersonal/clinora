...
/**
 * Couple Therapy Consent Form Template for Psychology
 */
class CoupleTherapyTemplate implements ConsentFormTemplateInterface
{
    /**
    ...
    public function generate(array $data, Professional $professional): string
    {
        ...
        return view('modules.psychology.consent-forms.couple-therapy', [
