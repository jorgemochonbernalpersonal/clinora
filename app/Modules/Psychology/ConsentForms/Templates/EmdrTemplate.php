...
/**
 * EMDR Consent Form Template for Psychology
 */
class EmdrTemplate implements ConsentFormTemplateInterface
{
    /**
    ...
    public function generate(array $data, Professional $professional): string
    {
        ...
        return view('modules.psychology.consent-forms.emdr', [
    ...
    public function getAdditionalFields(): array
    {
        return [
            'target_trauma' => [
                'type' => 'string',
                'label' => 'Trauma o evento objetivo',
                'required' => false,
            ],
            'session_duration' => [
                'type' => 'integer',
